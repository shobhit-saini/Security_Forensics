...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //Table to convert  64 bit keyto 56 bit
    int keyp[56]=  
    {    57,49,41,33,25,17,9, 
        1,58,50,42,34,26,18, 
        10,2,59,51,43,35,27, 
    ...
    //Number of bit shifts required in each round
    int shift_table[16]= 
    {    1, 1, 2, 2, 
        2, 2, 2, 2,  
        1, 2, 2, 2,  
    ...
    //Now we convert 56 bit key to 48 bit key 
    int key_comp[48]= 
    {    14,17,11,24,1,5, 
        3,28,15,6,21,10, 
        23,19,12,4,26,8, 
    ...
    //Splitting the key into two half
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////End_of_key_generation/////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      
    cout<< plain_text << "\nEncryption of" << plain_text <<":\n"; 
    string cipher= encrypt(plain_text, rkb); 
    cout<<"\nCipher Text: "<<cipher<<endl; 
      
    cout<<"\nDecryption:\n"; 
    reverse(rkb.begin(), rkb.end()); 
    string text= encrypt(cipher, rkb); 
